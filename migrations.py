...
"22": "CREATE TABLE amends (name CHAR(100), description TEXT, info_url CHAR(150))",
"23": "CREATE TABLE amendments (user_id INT, amend_id INT, garden_id INT, amended_at CHAR(150), quantity INT, pound INT, ounce INT, notes TEXT)"}
